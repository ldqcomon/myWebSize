  ...
  <div class="main0">
     ...
     <div class="main_right">
        ...
        <div class="txt">
            ...
            <input name="verifyCode" id="verifyCode" type="text" class="txtyzm" placeholder="请输入验证码"/>
            <img src="${pageContext.request.contextPath}/index/getVerifyCode" id="verifyCodeIMG" onclick="changeCode()" class="yzmimg"/>
        </div>
        <div class="xieyi">
